        ...
        <div className="md:max-w-md w-full px-6 py-6">
          <htmlForm>
            ...
            <div className="mt-12">
              ...
              <p className="flex justify-center text-[15px] mt-6 text-slate-600">Don't have an account <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</a></p>
